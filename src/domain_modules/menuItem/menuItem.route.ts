...
router.post('/', validation(menuItemSchema.createMenuItem), menuItemController.createMenuItem);
...
router.put('/:menuItemId', validation(menuItemSchema.updateMenuItem), menuItemController.updateMenuItem);

router.delete('/:menuItemId', validation(menuItemSchema.deleteMenuItem), menuItemController.deleteMenuItem);
